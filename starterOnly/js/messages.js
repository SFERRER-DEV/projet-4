...
const messages = [
  {
    name: "first",
    message: "Votre prénom doit avoir un minimum de 2 caractères.",
  },
  ...
  {
    name: "quantity",
    message: "Vous devez saisir le nombre de concours participés ou aucun.",
  },
  {
    name: "location",
    message: "Vous devez choisir une option pour un tournoi.",
  },
  {
    name: "accept1",
    message:
      "Vous devez vérifier que vous acceptez les termes et les conditions.",
  },
];
